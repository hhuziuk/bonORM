...
const buildTableQuery_1 = __importDefault(require("../../queries/buildTableQuery"));
...
function Entity(tableName) {
    return (target) => {
        ...
        const columnsStrings = columns.map(buildTableQuery_1.default.buildColumnDefinition);
        function createModel() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const query = buildTableQuery_1.default.buildCreateTableQuery(tableName, columnsStrings);
